...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_16600);
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq16601){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16602,G__16603,seq16601__$2);
}));
...
var vec__16607 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__16607,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__16607,(1),null);
var G__16610 = cljs.core.PersistentArrayMap.EMPTY;
var G__16610__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__16610,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16610);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__16610__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__16610__$1;
}
} else {
...
return (function() { 
var G__16614__delegate = function (klass,contents){
var vec__16611 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__16611,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__16611,(1),null);
...
var G__16614 = function (klass,var_args){
var contents = null;
...
while (G__16615__i < G__16615__a.length) {G__16615__a[G__16615__i] = arguments[G__16615__i + 1]; ++G__16615__i;}
  contents = new cljs.core.IndexedSeq(G__16615__a,0,null);
} 
return G__16614__delegate.call(this,klass,contents);};
G__16614.cljs$lang$maxFixedArity = 1;
G__16614.cljs$lang$applyTo = (function (arglist__16616){
var klass = cljs.core.first(arglist__16616);
var contents = cljs.core.rest(arglist__16616);
return G__16614__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__16620){
var map__16621 = p__16620;
var map__16621__$1 = (((((!((map__16621 == null))))?(((((map__16621.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16621.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16621):map__16621);
var ns = cljs.core.get.call(null,map__16621__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__16621__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__16623){
...
var actual = cljs.core.get.call(null,map__16624__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__16624__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__16626){
...
var expected = cljs.core.get.call(null,map__16627__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__16627__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__16629_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__16629_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__16631 = cljs_test_display.core.current_var_info.call(null);
var map__16631__$1 = (((((!((map__16631 == null))))?(((((map__16631.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16631.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16631):map__16631);
var info = map__16631__$1;
var name = cljs.core.get.call(null,map__16631__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__16631__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__16631__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__16630_SHARP_){
return cljs.core.cons.call(null,node,p1__16630_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__16633){
...
var m = map__16634__$1;
var fail = cljs.core.get.call(null,map__16634__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__16634__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__16634__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__16634__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___16636 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16636)){
var message_16637 = temp__5720__auto___16636;
cljs.core.println.call(null,message_16637);
} else {
}
...
var temp__5720__auto___16638 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16638)){
var message_16639 = temp__5720__auto___16638;
cljs.core.println.call(null,message_16639);
} else {
}
