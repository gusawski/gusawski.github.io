...
return cljs.core.map.call(null,(function (p1__16575_SHARP_){
return html_coll.item(p1__16575_SHARP_);
...
return cljs.core.some.call(null,(function (p1__16576_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__16576_SHARP_);
...
var ctx_16577 = cvs.getContext("2d");
(ctx_16577.fillStyle = color);

ctx_16577.fillRect((0),(0),size,size);
