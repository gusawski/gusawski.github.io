...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__16653_SHARP_){
return parseInt(p1__16653_SHARP_);
}),cljs.core.take.call(null,(3),clojure.string.split.call(null,v,/[^\d]/)))));
}catch (e16654){if((e16654 instanceof Error)){
var e = e16654;
...
var c_16656 = (new goog.debug.Console());
var G__16655_16657 = c_16656.getFormatter();
goog.object.set(G__16655_16657,"showAbsoluteTime",false);

goog.object.set(G__16655_16657,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_16656);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__16658_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__16658_SHARP_);
