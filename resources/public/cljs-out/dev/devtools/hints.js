...
var map__18970 = top_item;
var map__18970__$1 = (((((!((map__18970 == null))))?(((((map__18970.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18970.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18970):map__18970);
var file = cljs.core.get.call(null,map__18970__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18970__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18970__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e18969){var _e = e18969;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___18972 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___18972)){
var seen_errors_18973 = temp__5718__auto___18972;
if(cljs.core.truth_(seen_errors_18973.has(self))){
} else {
seen_errors_18973.add(self);

var temp__5720__auto___18974 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___18974)){
var sense_18975 = temp__5720__auto___18974;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_18975)].join(''));
} else {
}
}
} else {
