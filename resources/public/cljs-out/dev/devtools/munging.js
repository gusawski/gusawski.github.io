...
var o17824 = temp__5718__auto__;
var temp__5718__auto____$1 = (o17824["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o17825 = temp__5718__auto____$1;
return (o17825["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__16933__auto__ = f;
return (o__16933__auto__["toString"]).call(o__16933__auto__);
} else {
return "";
}
...
try{var o__16933__auto___17828 = t;
(o__16933__auto___17828["cljs$lang$ctorPrWriter"]).call(o__16933__auto___17828,t,writer);
}catch (e17827){var __17829 = e17827;
}
...
var char_code = (function (){var o__16933__auto__ = (new String(char$));
return (o__16933__auto__["charCodeAt"]).call(o__16933__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__16933__auto__ = String;
return (o__16933__auto__["fromCharCode"]).call(o__16933__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17830 = num_code;
switch (G__17830) {
case (1):
return (185);
...
var o__16933__auto__ = String;
return (o__16933__auto__["fromCharCode"]).call(o__16933__auto__,superscript_code);
});
/**
...
}catch (e17832){var _e__16940__auto__ = e17832;
return false;
}})())){
...
var vec__17833 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__17833,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o17836 = temp__5718__auto__;
var temp__5718__auto____$1 = (o17836["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o17837 = temp__5718__auto____$1;
return (o17837["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___17844 = arguments.length;
var i__4737__auto___17845 = (0);
while(true){
if((i__4737__auto___17845 < len__4736__auto___17844)){
args__4742__auto__.push((arguments[i__4737__auto___17845]));

var G__17846 = (i__4737__auto___17845 + (1));
i__4737__auto___17845 = G__17846;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17840){
var vec__17841 = p__17840;
var ns_detector = cljs.core.nth.call(null,vec__17841,(0),null);
...
var G__17847 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__17848 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__17847;
remaining_tokens = G__17848;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17838){
...
var vec__17852 = cljs.core.split_with.call(null,(function (p1__17851_SHARP_){
return cljs.core.not_EQ_.call(null,p1__17851_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__17852,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__17852,(1),null);
...
var vec__17858 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__17858,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__17858,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__17861 = cljs.core.rest.call(null,remaining_tokens);
var G__17862 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__17861;
name_tokens = G__17862;
continue;
} else {
...
var vec__17865 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__17865,(0),null);
var arity = cljs.core.nth.call(null,vec__17865,(1),null);
var vec__17868 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__17868,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__17868,(1),null);
var vec__17871 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__17871,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__17871,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__17871,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__17871,(3),null);
...
var vec__17877 = result;
var munged_ns = cljs.core.nth.call(null,vec__17877,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__17877,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__17877,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__17877,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__17877,(4),null);
var arity = cljs.core.nth.call(null,vec__17877,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__17881 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__17881,(0),null);
var args = cljs.core.nth.call(null,vec__17881,(1),null);
var vec__17884 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__17884,(0),null);
var name = cljs.core.nth.call(null,vec__17884,(1),null);
...
var G__17887 = (arity + (1));
var G__17888 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__17889){
var vec__17890 = p__17889;
var arity = cljs.core.nth.call(null,vec__17890,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__17890,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17893_SHARP_){
return cljs.core.get.call(null,arities,p1__17893_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__17894_SHARP_){
return cljs.core.drop.call(null,(2),p1__17894_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___17901 = arguments.length;
var i__4737__auto___17902 = (0);
while(true){
if((i__4737__auto___17902 < len__4736__auto___17901)){
args__4742__auto__.push((arguments[i__4737__auto___17902]));

var G__17903 = (i__4737__auto___17902 + (1));
i__4737__auto___17902 = G__17903;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__17897){
var vec__17898 = p__17897;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__17898,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq17895){
var G__17896 = cljs.core.first.call(null,seq17895);
var seq17895__$1 = cljs.core.next.call(null,seq17895);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17896,seq17895__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__17906__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__17906__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__17906__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__17906__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__17907 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__17907,(0),null);
var fn_name = cljs.core.nth.call(null,vec__17907,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__17907,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__17907,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__17907,(4),null);
var arity = cljs.core.nth.call(null,vec__17907,(5),null);
...
var o__16933__auto__ = f;
return (o__16933__auto__["getBasis"]).call(o__16933__auto__);
});
/**
...
}catch (e17911){var _e__16940__auto__ = e17911;
...
var G__17912 = (obj[cljs.core.first.call(null,path)]);
var G__17913 = cljs.core.rest.call(null,path);
obj = G__17912;
path = G__17913;
continue;
} else {
...
var _STAR_ = (function (accum,p__17914){
var vec__17915 = p__17914;
var bit = cljs.core.nth.call(null,vec__17915,(0),null);
var protocol = cljs.core.nth.call(null,vec__17915,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__17918){
var vec__17919 = p__17918;
var ns = cljs.core.nth.call(null,vec__17919,(0),null);
var name = cljs.core.nth.call(null,vec__17919,(1),null);
var selector = cljs.core.nth.call(null,vec__17919,(2),null);
...
var post_process = (function (p__17923){
var vec__17924 = p__17923;
var munged_name = cljs.core.nth.call(null,vec__17924,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__17924,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17922_SHARP_){
return (obj[cljs.core.first.call(null,p1__17922_SHARP_)]);
}),sorted_matches);
