...
var len__4736__auto___17958 = arguments.length;
var i__4737__auto___17959 = (0);
while(true){
if((i__4737__auto___17959 < len__4736__auto___17958)){
args__4742__auto__.push((arguments[i__4737__auto___17959]));

var G__17960 = (i__4737__auto___17959 + (1));
i__4737__auto___17959 = G__17960;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq17955){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17956,G__17957,seq17955__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__17961_SHARP_){
return (!((cljs.core.meta.call(null,p1__17961_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__17962__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e17966){var _e__16940__auto__ = e17966;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e17968){var _e__16940__auto__ = e17968;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__17970 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__17971 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__17971);

try{var map__17972 = opts;
...
var markup_db = cljs.core.get.call(null,map__17972__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__17970);
}});
...
var temp__5718__auto___17977 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___17977)){
var managed_print_level_17978 = temp__5718__auto___17977;
var _STAR_print_level_STAR__orig_val__17975_17979 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__17976_17980 = managed_print_level_17978;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__17976_17980);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__17974_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__17974_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__17975_17979);
}} else {
job_fn.call(null);
}
