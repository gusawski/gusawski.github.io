...
if((i < len)){
var k = (ks[i]);
var G__14836 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__14837 = (i + (1));
m = G__14836;
i = G__14837;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__14839 = c;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__14841 = c;
...
return (function() { 
var G__14844__delegate = function (args){
...
while (G__14845__i < G__14845__a.length) {G__14845__a[G__14845__i] = arguments[G__14845__i + 0]; ++G__14845__i;}
  args = new cljs.core.IndexedSeq(G__14845__a,0,null);
} 
...
var G__14848 = c;
var G__14848__$1 = (((G__14848 == null))?null:G__14848.constructor);
if((G__14848__$1 == null)){
return null;
} else {
return G__14848__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__14849 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__14850 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__14850);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__14849);
}});
...
var c = this;
var G__14854_14856 = goog.object.get(c,"cljsRatom");
if((G__14854_14856 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__14854_14856);
}
...
var renders_14857 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_14858 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_14857));
...
if((cljs.core.count.call(null,renders_14857) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_14857))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_14858)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_14858)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__14859 = o;
goog.object.set(G__14859,cljs.core.name.call(null,k),v);
