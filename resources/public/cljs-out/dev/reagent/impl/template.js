...
var G__14872 = o;
goog.object.set(G__14872,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__14874__i < G__14874__a.length) {G__14874__a[G__14874__i] = arguments[G__14874__i + 0]; ++G__14874__i;}
  args = new cljs.core.IndexedSeq(G__14874__a,0,null);
} 
...
var G__14876 = o;
goog.object.set(G__14876,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__14878__i < G__14878__a.length) {G__14878__a[G__14878__i] = arguments[G__14878__i + 0]; ++G__14878__i;}
  args = new cljs.core.IndexedSeq(G__14878__a,0,null);
} 
...
var G__14880 = props;
var G__14880__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__14880,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14880);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14880__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__14880__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__14881 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14881,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__14881;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14882){
...
var on_write = cljs.core.get.call(null,map__14883__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__14885_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14885_SHARP_);
}));
} else {
return null;
}
...
var vec__14888 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14888,(0),null);
var id = cljs.core.nth.call(null,vec__14888,(1),null);
var className = cljs.core.nth.call(null,vec__14888,(2),null);
...
var temp__5724__auto___14892 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___14892 == null)){
} else {
var key_14893 = temp__5724__auto___14892;
(jsprops.key = key_14893);
}
...
var temp__5724__auto___14894 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___14894 == null)){
} else {
var key_14895 = temp__5724__auto___14894;
(jsprops.key = key_14895);
}
...
var temp__5724__auto___14896 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___14896 == null)){
} else {
var key_14897 = temp__5724__auto___14896;
(jsprops.key = key_14897);
}
...
var G__14899 = n;
if(cljs.core._EQ_.call(null,"",G__14899)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__14899)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14900){
...
break;
default:
var G__14907 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__14907;
continue;
...
var ctx = ({});
var vec__14909 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__14909,(0),null);
var derefed = cljs.core.nth.call(null,vec__14909,(1),null);
...
var G__14912 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14912) {
case (0):
