...
return cljs.core.assoc.call(null,G__16511,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__16511;
}
}));
...
var len__4736__auto___16516 = arguments.length;
var i__4737__auto___16517 = (0);
while(true){
if((i__4737__auto___16517 < len__4736__auto___16516)){
args__4742__auto__.push((arguments[i__4737__auto___16517]));

var G__16518 = (i__4737__auto___16517 + (1));
i__4737__auto___16517 = G__16518;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq16513){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16514,G__16515,seq16513__$2);
}));
...
var map__16520 = m;
var map__16520__$1 = (((((!((map__16520 == null))))?(((((map__16520.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16520.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16520):map__16520);
var file = cljs.core.get.call(null,map__16520__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__16520__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__16520__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__16519_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__16519_SHARP_));
...
var temp__5720__auto___16522 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16522)){
var message_16523 = temp__5720__auto___16522;
cljs.core.println.call(null,message_16523);
} else {
}
...
var temp__5720__auto___16524 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___16524)){
var message_16525 = temp__5720__auto___16524;
cljs.core.println.call(null,message_16525);
} else {
}
...
var output_dir__$1 = (function (){var G__16526 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__16526,"/"].join('');
} else {
return G__16526;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__16528 = exception.stack;
var G__16528__$1 = (((G__16528 == null))?null:clojure.string.split_lines.call(null,G__16528));
var G__16528__$2 = (((G__16528__$1 == null))?null:cljs.core.get.call(null,G__16528__$1,depth));
if((G__16528__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__16528__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__16529 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__16529,(0),null);
var column = cljs.core.nth.call(null,vec__16529,(1),null);
var vec__16532 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__16532,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__16532,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__16532,(2),null);
...
var m__$1 = (function (){var G__16535 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__16539 = (function (){var G__16538 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__16538);
} else {
return G__16538;
}
})();
...
return cljs.core.vary_meta.call(null,G__16540,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__16544 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__16544,(0),null);
var types = vec__16544;
...
return cljs.core.map.call(null,(function (p__16547){
var vec__16548 = p__16547;
var ns = cljs.core.nth.call(null,vec__16548,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__16548,(1),null);
return (function (){
...
var G__16551 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__16552 = cljs.core.seq.call(null,vars__$1);
var chunk__16553 = null;
var count__16554 = (0);
var i__16555 = (0);
while(true){
if((i__16555 < count__16554)){
var v = cljs.core._nth.call(null,chunk__16553,i__16555);
var temp__5720__auto___16557 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___16557)){
var t_16558 = temp__5720__auto___16557;
each_fixture_fn.call(null,((function (seq__16552,chunk__16553,count__16554,i__16555,t_16558,temp__5720__auto___16557,v,each_fixture_fn,G__16551,G__16551__$1,env,once_fixtures,each_fixtures,vec__16548,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16558)));
});})(seq__16552,chunk__16553,count__16554,i__16555,t_16558,temp__5720__auto___16557,v,each_fixture_fn,G__16551,G__16551__$1,env,once_fixtures,each_fixtures,vec__16548,ns,vars__$1))
);
} else {
}


var G__16559 = seq__16552;
var G__16560 = chunk__16553;
var G__16561 = count__16554;
var G__16562 = (i__16555 + (1));
seq__16552 = G__16559;
chunk__16553 = G__16560;
count__16554 = G__16561;
i__16555 = G__16562;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__16552);
if(temp__5720__auto__){
var seq__16552__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__16552__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__16552__$1);
var G__16563 = cljs.core.chunk_rest.call(null,seq__16552__$1);
var G__16564 = c__4556__auto__;
var G__16565 = cljs.core.count.call(null,c__4556__auto__);
var G__16566 = (0);
seq__16552 = G__16563;
chunk__16553 = G__16564;
count__16554 = G__16565;
i__16555 = G__16566;
continue;
} else {
var v = cljs.core.first.call(null,seq__16552__$1);
var temp__5720__auto___16567__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___16567__$1)){
var t_16568 = temp__5720__auto___16567__$1;
each_fixture_fn.call(null,((function (seq__16552,chunk__16553,count__16554,i__16555,t_16568,temp__5720__auto___16567__$1,v,seq__16552__$1,temp__5720__auto__,each_fixture_fn,G__16551,G__16551__$1,env,once_fixtures,each_fixtures,vec__16548,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16568)));
});})(seq__16552,chunk__16553,count__16554,i__16555,t_16568,temp__5720__auto___16567__$1,v,seq__16552__$1,temp__5720__auto__,each_fixture_fn,G__16551,G__16551__$1,env,once_fixtures,each_fixtures,vec__16548,ns,vars__$1))
);
} else {
}


var G__16569 = cljs.core.next.call(null,seq__16552__$1);
var G__16570 = null;
var G__16571 = (0);
var G__16572 = (0);
seq__16552 = G__16569;
chunk__16553 = G__16570;
count__16554 = G__16571;
i__16555 = G__16572;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16551__$1)].join('')));
